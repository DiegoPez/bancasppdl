        ...
        call.enqueue(new Callback<TransferResponse>() {
            ...
            public void onResponse(Call<TransferResponse> call, Response<TransferResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    Toast.makeText(RTransaction.this, "Transferencia exitosa: " + response.body().getMessage(), Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(RTransaction.this, "Error en la transferencia", Toast.LENGTH_LONG).show();
                }
            }
